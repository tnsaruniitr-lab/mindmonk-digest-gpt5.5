export const PSYCHOLOGY_TEMPLATE = `Focus on:
- Core psychological concepts or frameworks introduced
- Cognitive biases or mental traps identified
- Practical behavioral change techniques
- Research studies cited (with key findings and sample sizes if mentioned)
